package com.pramod.dreamshops.security.jwt;

import com.pramod.dreamshops.security.user.ShopUserDetails;
...
public class JwtUtils {
    ...
    public String generateTokenForUser(Authentication authentication) {
        ...
        List<String> roles = userPrinciple.getAuthorities().stream().map(grantedAuthority -> grantedAuthority.getAuthority()).toList();
        return Jwts.builder()
